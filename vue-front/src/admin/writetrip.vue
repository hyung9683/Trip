<template>
        ...
        <form @submit.prevent="savePost">
          <table class="tbAdd">
            ...
            <tr>
              <th>이름</th>
              <td class="left-align">
                <input type="text" v-model="Tvs.TvTitle" class="large-input" placeholder="이름을 입력해주세요">
              </td>
            </tr>
            <tr>
              <th>주소</th>
              <td class="left-align">
                <input type="text" v-model="Tvs.TvAddress" class="large-input" placeholder="주소를 입력해주세요">
              </td>
            </tr>
            <tr>
              <th>내용</th>
                <td class="left-align">
                  <textarea v-model="Tvs.TvContent" class="large-textarea" placeholder="내용을 입력해주세요"></textarea>
                </td>
            </tr>
            <tr>
              <th>지역</th>
  ...
  try {
    ...
    formData.append('upload', this.Tvs.TvImg);
    ...
    const tvSubImages = [
      this.Tvs.TvSubImg[0] || null,
      this.Tvs.TvSubImg[1] || null,
      this.Tvs.TvSubImg[2] || null,
      this.Tvs.TvSubImg[3] || null
    ];

    const response = await axios.post('http://localhost:3000/admin/tripwrite', {
      user_no: userNo, // 사용자 번호 추가
      tv_tit: this.Tvs.TvTitle,
      ...
      tv_sb_img3: tvSubImages[2],
      tv_sb_img4: tvSubImages[3],
    });
